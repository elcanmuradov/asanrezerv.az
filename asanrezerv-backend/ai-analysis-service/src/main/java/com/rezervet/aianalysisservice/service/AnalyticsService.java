...
public class AnalyticsService {
    ...
    public List<ReservationDto> reservations(UUID userId,UUID restaurantId) {
        List<ReservationDto> list = data(reservationClient.getByRestaurant(userId,restaurantId));
        return list == null ? List.of() : list;
    }

    public AiSummaryDto computeSummary(UUID userId, UUID restaurantId) {
        List<ReservationDto> reservations = reservations(userId, restaurantId);
