...
public class ForecastService {
    ...
    public ForecastDto forecast(UUID userId,UUID restaurantId, int days) {
        List<ReservationDto> reservations = analyticsService.reservations(userId,restaurantId).stream()
