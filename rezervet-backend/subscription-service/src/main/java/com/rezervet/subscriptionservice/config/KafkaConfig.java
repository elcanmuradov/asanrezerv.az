package com.rezervet.subscriptionservice.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, RestaurantDto> restaurantConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,"com.rezervet.subscriptionservice.dto.kafka.RestaurantDto");
        props.put(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, false);
    ...
    public ConsumerFactory<String, TableCreationEvent> tableCreationEventConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,"com.rezervet.subscriptionservice.dto.kafka.TableCreationEvent");
        props.put(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, false);
    ...
    public ConsumerFactory<String, BranchCreationEvent> branchCreationEventConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,"com.rezervet.subscriptionservice.dto.kafka.BranchCreationEvent");
        props.put(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, false);
