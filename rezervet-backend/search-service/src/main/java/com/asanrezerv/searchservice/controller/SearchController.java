package com.asanrezerv.searchservice.controller;
...
import com.asanrezerv.searchservice.dto.ApiResponse;
import com.asanrezerv.searchservice.service.SearchService;
...
public class SearchController {
    ...
    public ResponseEntity<ApiResponse<Page<RestaurantDocument>>> getRestaurants(@PageableDefault(page = 0,size = 20) Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(searchService.getRestaurants(pageable)));
    }
