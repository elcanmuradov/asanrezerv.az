...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, BranchDto> branchConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,"com.rezervet.searchservice.dto.kafka.branch.BranchDto");
        props.put(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, false);
    ...
    public ConsumerFactory<String, RestaurantDto> restaurantConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,"com.rezervet.searchservice.dto.kafka.restaurant.RestaurantDto");
    ...
    public ConsumerFactory<String, RestaurantSubscribed> subscriptionConsumerFactory() {
        ...
        props.put(JacksonJsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JacksonJsonDeserializer.VALUE_DEFAULT_TYPE,"com.rezervet.searchservice.dto.kafka.subscription.RestaurantSubscribed");
        props.put(JacksonJsonDeserializer.USE_TYPE_INFO_HEADERS, true);
