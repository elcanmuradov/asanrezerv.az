...
public class SubscriptionService {
    ...
    public SubscriptionDto checkout(UUID restaurantId, UUID planId) {
        ...
        var currentOpt = subscriptionRepository.findSubscriptionByRestaurantIdAndStatus(restaurantId,SubscriptionStatus.ACTIVE);

        if (currentOpt.isPresent()) {
            var currentSubscription = currentOpt.get();
